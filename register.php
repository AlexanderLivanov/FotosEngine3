...
if(!empty($_POST['register'])){
    ...
    if($query->rowCount() == 0){
        $query = $connect->prepare("INSERT INTO users(username, passwd, reg_date, last_activity, invited_by, rating, role, ip) VALUES 
                                                    (:username, :passwd_hash, :local_datetime, :local_datetime, :ref, '1', '0', '0:0:0:0');");
        $query->bindParam("username", $username, PDO::PARAM_STR);
